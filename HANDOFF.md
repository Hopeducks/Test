...
- ✅ **H1 완료**: 전 단원 MC 문항 힌트 완성 24→320개 (커밋 41dee3c)
- ✅ **H3 완료**: CSV 내보내기 + 학생 오프라인 제출 코드 수집 (커밋 24af7f6)
- ✅ **I2 완료**: 빔프로젝터 접근성 — QuizScreen 보기/해설/정답 text-xl, MatchingRenderer touch-target, PokedexHome 버튼 text-base (커밋 837ab94)
